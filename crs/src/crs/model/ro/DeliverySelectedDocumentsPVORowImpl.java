...
// ---    Sun Sep 03 16:22:27 EEST 2023
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class DeliverySelectedDocumentsPVORowImpl
  extends ProgrammaticViewRowImpl
{
  ...
  protected enum AttributesEnum
  {
    ...
    DisplayDocumentType,
    StartPage,
    SsoActiveLookupValuesVwViewDocumentType;
  ...
  public static final int DOCUMENTPK = AttributesEnum.DocumentPk.index();
  public static final int DOCUMENTNO = AttributesEnum.DocumentNo.index();
  public static final int DISPLAYDOCUMENTTYPE = AttributesEnum.DisplayDocumentType.index();
  public static final int STARTPAGE = AttributesEnum.StartPage.index();
  public static final int SSOACTIVELOOKUPVALUESVWVIEWDOCUMENTTYPE =
    AttributesEnum.SsoActiveLookupValuesVwViewDocumentType.index();

  /**
   * This is the default constructor (do not remove).
   */
  public DeliverySelectedDocumentsPVORowImpl()
  {
  }
}
