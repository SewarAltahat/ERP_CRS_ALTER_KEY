...
// ---    Mon Jul 03 17:04:27 GMT+03:00 2023
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class CrsDeptGroupTlImpl
  extends AuditEntityImpl
{
  ...
  {
    return EntityDefImpl.findDefObject("crs.model.eo.CrsDeptGroupTl");
  }


  /**
   * Gets the attribute value for DeptGroupTlPk, using the alias name DeptGroupTlPk.
   * @return the value of DeptGroupTlPk
   */
  ...
  /**
   * Sets <code>value</code> as the attribute value for DeptGroupTlPk.
   * @param value value to set the DeptGroupTlPk
   */
  ...
  /**
   * @param deptGroupTlPk key constituent

   * @return a Key object based on given key constituents.
   */
  public static Key createPrimaryKey(BigDecimal deptGroupTlPk)
  {
    return new Key(new Object[] { deptGroupTlPk });
  }
  ...
  protected void doDML(int operation, oracle.jbo.server.TransactionEvent e)
  {
    ...
    {
      BigDecimal deptGroupTlPk = gen.common.GenLib.getPrimaryKeyValue(getDBTransaction(), "CRS_DEPT_GROUP_TL_SEQ");
      setDeptGroupTlPk(deptGroupTlPk);
    }
  }
